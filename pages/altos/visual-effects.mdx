...
To render transparent materials behind clouds, see the [pre-transparency pass section of our getting started doc](/altos/start#set-up-your-pre-transparency-pass).
